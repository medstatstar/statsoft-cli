...
name: statsoft-cli
slug: statsoft-cli
displayName: Statsoft-CLI / 跨平台统计软件 CLI 集成（34+ 软件包）
version: 2.6.18
summary: Cross-platform statistical software CLI integration for AI Agent; 34+ packages (R/Stata/SAS/SPSS/Python/Bayesian/ML). Default-deny, opt-in, bilingual. / 跨平台统计软件 CLI 集成，面向 AI Agent；覆盖 34+ 款软件（R/Stata/SAS/SPSS/Python/贝叶斯/ML）。默认拒绝、需显式授权，双语。
license: MIT
